...
You just have to fill the values in the middle with what you want your program to look like. Then, count the width (from the first line) and height (from top to down) of your map, type them in like:
width height
